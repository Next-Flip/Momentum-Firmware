...
void momentum_app_scene_interface_on_enter(void* context) {
    ...
    variable_item_list_add(var_item_list, "Lock Screen", 0, NULL, app);

    variable_item_list_add(var_item_list, "Status Bar", 0, NULL, app);

    variable_item_list_add(var_item_list, "File Browser", 0, NULL, app);

    variable_item_list_add(var_item_list, "General", 0, NULL, app);
