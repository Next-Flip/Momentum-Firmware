...
4.  **Device Operation:** To ensure the continued operation of the user's device due to the fact that vibecoding any low-level project is a bad idea as you run the risk of irrecoverably bricking the device that it is ran on.
